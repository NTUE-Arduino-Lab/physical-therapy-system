...
const IconCheck = ({ width = '70%', height = '70%', fill, onClick }) => (
    <svg
        width="100%"
        height="100%"
        viewBox="0 0 48 48"
